...
<html>
	...
	<title>Salt Internationals &mdash; | Terms & Conditions</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Terms and Conditions of Salt International" />
	<meta name="keywords" content="terms conditions, salt international" />
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url('{{ asset('images/about-us.jpg') }}');">
				...
				<div class="row animate-box">
					<div class="col-md-12">
						<div class="desc">
							...
							<p>Welcome to Salt International. These terms and conditions outline the rules and regulations for the use of Salt International's Website.</p>
                            
                            <h3>1. Acceptance of Terms</h3>
                            <p>By accessing this website, we assume you accept these terms and conditions in full. Do not continue to use Salt International's website if you do not accept all of the terms and conditions stated on this page.</p>

                            <h3>2. Intellectual Property</h3>
                            <p>Unless otherwise stated, Salt International and/or its licensors own the intellectual property rights for all material on Salt International. All intellectual property rights are reserved. You may view and/or print pages from https://saltinternational.com for your own personal use subject to restrictions set in these terms and conditions.</p>
                            ...
                            <p>In no event shall Salt International, nor any of its officers, directors, and employees, be liable to you for anything arising out of or in any way connected with your use of this website, whether such liability is under contract, tort or otherwise.</p>

                            <h3>5. Governing Law</h3>
                            <p>These terms and conditions will be governed by and construed in accordance with the laws of the jurisdiction, and you submit to the non-exclusive jurisdiction of the state and federal courts located in for the resolution of any disputes.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row row-pb-md footer-items ">
				<div class="col-md-4 fh5co-widget">
					<span><a href="{{ url('/') }}"><img class="logo2" src="{{ asset('images/Logo_fitted.png') }}" alt="Salt International" loading="lazy"></a></span>
