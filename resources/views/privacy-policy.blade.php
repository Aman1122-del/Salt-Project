...
<html>
	...
	<title>Salt Internationals &mdash; | Privacy Policy</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Privacy Policy of Salt International" />
	<meta name="keywords" content="privacy policy, salt international" />
				...
				<div class="row animate-box">
					<div class="col-md-12">
						<div class="desc">
							...
							<p>At Salt International, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you visit our website or interact with our services.</p>
                            
                            <h3>1. Information We Collect</h3>
                            <p>We may collect personal information that you voluntarily provide to us when you fill out forms on our website, such as your name, email address, phone number, and company details. We may also collect non-personal information automatically, such as your IP address, browser type, and operating system.</p>

                            <h3>2. How We Use Your Information</h3>
                            <p>We use the information we collect to:</p>
                            <ul>
                                <li>Provide and maintain our services to you.</li>
                                <li>Respond to your inquiries and Quotation requests.</li>
                                <li>Process orders and shipments.</li>
                                <li>Send you updates, promotional materials, and other information related to our products.</li>
                            </ul>

                            <h3>3. Data Security</h3>
                            <p>We implement appropriate technical and organizational measures to protect your personal data against unauthorized access, alteration, disclosure, or destruction. However, please be aware that no method of transmission over the internet or method of electronic storage is 100% secure.</p>
                            ...
                            <h3>5. Contact Us</h3>
                            <p>If you have any questions regarding this Privacy Policy, please contact us at <a href="mailto:info@saltinternational.com">info@saltinternational.com</a>.</p>
						</div>
					</div>
				</div>
			</div>
