...
<html>
	...
	<title>Salt Internationals &mdash; | About Us</title>
		...
		<div class="container">
			<div class="about-content">
				<div class="row animate-box">
					<div class="col-md-6">
						<div class="desc">
							<span class="legacy-subtitle">A Vision Beyond Profit</span>
							<h2>How It Established A Legacy Since 2001</h2>
					...
					<div class="col-md-6">
						<img class="img-responsive" src="{{ asset('images/about.jpeg') }}" alt="about">
					</div>
				</div>
			</div>
		</div>
