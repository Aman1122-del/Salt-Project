;(function () {
	...
	var quotationPopup = function() {
		// Open popup on load (with delay)
		setTimeout(function() {
			$('#quotation-popup').addClass('show');
		...
		$('#quotation-popup').on('click', function(e) {
	...
	$(function(){
		quotationPopup(); // Run this first to ensure it triggers
